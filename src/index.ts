			...
			const ins =
				await c.env.DB.prepare(
					...
					.bind(
						sid,
						body.petId,
						body.points[0].expectedAt.slice(
							0,
							10,
						),
						body.notes ??
...
registry.registerPath(
	{
		...
		summary:
			"Criar sessão de curva glicêmica",
		request:
			{
				body: {
					content:
...
registry.registerPath(
	{
		...
		summary:
			"Detalhar sessão de curva glicêmica",
		request:
			{
				params: z.object(
					{
...
registry.registerPath(
	{
		...
		summary:
			"Atualizar ponto da curva glicêmica",
		request:
			{
				params: z.object(
					{
...
registry.registerPath(
	{
		...
		path: "/lab/results",
		summary:
			"Listar resultados de exame (por pet)",
		request:
			{
				query: PetIdQuery.merge(
					ListQuery.partial(),
				),
			},
		responses:
...
registry.registerPath(
	{
		...
		path: "/vaccines/applications",
		summary:
			"Listar aplicações de vacina (por pet)",
		request:
			{
				query: PetIdQuery.merge(
					ListQuery.partial(),
...
registry.registerPath(
	{
		...
		path: "/treatments",
		summary:
			"Listar tratamentos (opcional por pet)",
		request:
			{
				query: z.object(
					{
...
registry.registerPath(
	{
		...
		path: "/vet/visits",
		summary:
			"Registrar visita ao veterinário",
		request:
			{
				body: {
					content:
...
registry.registerPath(
	{
		...
		path: "/vet/visits",
		summary:
			"Listar visitas (opcional por pet)",
		request:
			{
				query: z.object(
					{
...
registry.registerPath(
	{
		...
		path: "/alerts/due",
		summary:
			"Alertas próximos (aniversários, vacinas, glicemia)",
		request:
			{
				query: z.object(
					{
